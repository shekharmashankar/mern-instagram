        ...
        user
          ...
          .then((user) => {
            transporter.sendMail({
              to: user.email,
              from: "sagarbarapatre.me@gmail.com",
              subject: "Welcome to Instagram Clone by Sagar Barapatre!",
    ...
    bcrypt
      ...
      .then((doMatch) => {
        if (doMatch) {
          ...
          const { _id, name, email, followers, following, profilePic } =
            savedUser;
          res.json({
            token: token,
  ...
  crypto.randomBytes(32, (err, buffer) => {
    ...
    User.findOne({ email: req.body.email }).then((user) => {
      ...
      user.save().then((result) => {
        transporter.sendMail({
          to: user.email,
          from: "sagarbarapatre.me@gmail.com@gmail.com",
